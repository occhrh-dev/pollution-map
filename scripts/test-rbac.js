...
test('System APIs cannot be invoked by ordinary agency administrators',()=>{const f=fixture();for(const action of ['systemListAgencies','systemListRegistrationRequests','systemListMembers','systemSetAgencyStatus','systemSetMember','systemBackupStatus','systemCreateBackup'])f.denied('a',action,{targetAgencyId:'B',status:'SUSPENDED',member:{email:'b@example.org',role:'ADMIN'}});});
