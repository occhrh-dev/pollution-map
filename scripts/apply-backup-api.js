...
if(!code.includes('systemBackupStatus:systemBackupStatus_')){
...
if(!code.includes('function authorizeSystemOwner_')){
  code=replaceOnce(code,
...
if(!test.includes("'systemBackupStatus','systemCreateBackup'")){
...
if(!test.includes("test('Backup endpoints are owner-only")){
  test=replaceOnce(test,
